...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      // let infectedResult = await qr_covid.findAll({
      //   where: {
      //     EmpNo: empNo,
      //     Update: {
      ...
      //     Getdata: { [Op.like]: "C" + "%" },
      //   },
      //   attributes: ["Update", "EmpNo", "Getdata"],
      // });
  ...
  order by [Update]`);
      ...
      for (let index in infectedResult) {
        // let riskStartTime = moment(infectedResult[index].Update).add(
        //   -riskTimeMin,
        //   "hours"
        // );
        // let riskToTime = moment(infectedResult[index].Update).add(
        //   riskTimeMax,
        //   "hours"
        // );
        ...
        // let riskPeople = await qr_covid.findAll({
        //   where: {
        //     Update: {
        //       [Op.between]: [riskStartTime, riskToTime],
        //     },
        //     Getdata: infectedResult[index].Getdata,
        //     EmpNo: { [Op.not]: empNo },
        //   },
        //   attributes: ["Update", "EmpNo", "Getdata"],
        // });
